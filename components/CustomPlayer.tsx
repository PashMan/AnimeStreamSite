...
class Anime4KWebGL {
  ...
  constructor(canvas: HTMLCanvasElement, video: HTMLVideoElement) {
    ...
    // PASS 3: High-Fidelity Edge Thinning, Adaptive Contrast & Sharpening at output resolution
    const fsRefineSource = `
      ...
      void main() {
        ...
        float local_var = clamp(grad * 12.0, 0.0, 1.0);
