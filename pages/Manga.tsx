...
const Manga: React.FC = () => {
  ...
  return (
    <div className="bg-[#141519] min-h-screen text-slate-100 pb-24 font-sans select-none">
      ...
      <div className="bg-gradient-to-r from-primary/20 via-[#141519]/90 to-[#141519] border-b border-primary/10 py-10 px-4 sm:px-8 lg:px-12">
            ...
            return (
              ...
              >
                <div className="relative aspect-[2/3] w-full overflow-hidden">
                  ...
                  >
                    <Heart className={`w-4 h-4 ${isFaved ? 'fill-current text-primary hover:text-black' : ''}`} />
                  </button>
                  ...
                  <div className="absolute bottom-3 left-3 right-3 z-10 flex items-center justify-between">
                    ...
                    <span className="text-xs font-black text-slate-200 bg-primary/90 px-2.5 py-1 rounded-lg flex items-center gap-1 shadow-md">
                      {manga.chapters} гл.
                    </span>
                  </div>
                </div>
            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-12 gap-8 p-6 sm:p-10">
                ...
                <div className="col-span-1 md:col-span-4 space-y-4">
                  ...
                  <div className="bg-[#23252b] p-4 rounded-xl flex items-center justify-around border border-white/5">
                    ...
                    <div className="text-center">
                      ...
                      <div className="text-lg font-black text-primary">{selectedManga.chapters}</div>
                    </div>
                  </div>
                </div>
                ...
                <div className="col-span-1 md:col-span-8 flex flex-col justify-between space-y-6">
                  ...
                  {/* Chapters List */}
                  <div className="space-y-4">
                    <h4 className="text-xs font-black uppercase tracking-widest text-primary">Доступные Главы</h4>
                    <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 max-h-[300px] overflow-y-auto pr-2 custom-scrollbar">
                      {Array.from({ length: 5 }).map((_, index) => {
                        ...
                        return (
                          ...
                          >
                            <div>
                              <div className="text-[9px] font-extrabold uppercase text-slate-500 group-hover/chapter:text-primary">Том 1</div>
                              <div className="text-sm font-black text-white">Глава {chapterNum}</div>
                            </div>
                            <ChevronRight className="w-4 h-4 text-slate-600 group-hover/chapter:text-primary transition-transform group-hover/chapter:translate-x-1" />
                          </button>
                        );
                      })}
                    </div>
            ...
            <div className="bg-[#141519] px-6 py-4 border-b border-white/5 flex items-center justify-between">
              <div className="flex items-center gap-4">
                <button 
                  ...
                  className="p-2 bg-[#23252b] text-white hover:text-primary rounded-xl transition-colors"
                >
                  <ArrowLeft className="w-5 h-5" />
                </button>
                <div>
            ...
            <div className="bg-[#141519] p-4 flex items-center justify-center gap-2 border-t border-white/5">
              {selectedManga.pages.map((_, idx) => (
                <button 
                  ...
                  className={`w-3.5 h-3.5 rounded-full transition-all duration-300 ${idx === mangaReaderPage ? 'bg-primary scale-125' : 'bg-slate-700 hover:bg-slate-500'}`}
                />
              ))}
            </div>
          </motion.div>
