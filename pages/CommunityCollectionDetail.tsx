...
import { Loader2, ChevronLeft, Users, Calendar, Info } from 'lucide-react';
  ...
  useEffect(() => {
    ...
    const loadData = async () => {
      ...
      try {
        ...
        if (data) {
          setCollection(data);
          // Convert collection items to Anime objects for AnimeCard
          const animes: Anime[] = (data.items || []).map((item: any) => ({
            id: item.animeId,
            title: item.animeTitle || 'Unknown',
