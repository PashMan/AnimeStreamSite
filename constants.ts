...
export const COLLECTIONS_DATA = [
  ...
  { id: 'urban-fantasy', title: 'Городское фэнтези', defaultGenre: 'Городское фэнтези', color: 'from-indigo-600/80 to-blue-900/90', image: 'https://picsum.photos/seed/urban-fantasy/800/600', count: '100+' },
  { id: 'villainess', title: 'Злодейка', defaultGenre: 'Злодейка', color: 'from-purple-600/80 to-indigo-900/90', image: 'https://picsum.photos/seed/villainess/800/600', count: '100+' },
  { id: 'cgdct', title: 'Милые девушки делают милые вещи', defaultGenre: 'CGDCT', color: 'from-pink-400/80 to-rose-600/90', image: 'https://picsum.photos/seed/cgdct/800/600', count: '100+' },
  { id: 'anthropomorphism', title: 'Антропоморфизм', defaultGenre: 'Антропоморфизм', color: 'from-orange-400/80 to-amber-700/90', image: 'https://picsum.photos/seed/anthropomorphism/800/600', count: '100+' },
